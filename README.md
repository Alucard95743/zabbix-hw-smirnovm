...
`На скриншотах мы можем увидеть созданный шаблон для мониторинга CPU и RAM в процентах. На втором скриншоте указаные ключи`
...
`На скриншоте мы можем увидеть, что шаблоны Custom CPU RAM Monitoring из задания 1 и Linux by zabbix-agent назначены на обе виртуальные машины`
...
`На скриншоте мы можем увидеть созданный дашборд отображающий метрики по созданному нами ранее шаблону с двух машин, smirnovmi-1 и smirnovmi-2`
